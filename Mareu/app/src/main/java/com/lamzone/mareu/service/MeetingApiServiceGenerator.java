...
public abstract class MeetingApiServiceGenerator {
    ...
    public static List<Meeting> DUMMY_MEETING = Arrays.asList(
        new Meeting(1, "Peach", DUMMY_ROOM.get(0), "14:00", Arrays.asList(
                DUMMY_USER.get(0),
                DUMMY_USER.get(1),
                DUMMY_USER.get(2)
                )),
        new Meeting(2, "Mario", DUMMY_ROOM.get(1), "13:00", Arrays.asList(
                DUMMY_USER.get(3),
                DUMMY_USER.get(4),
                DUMMY_USER.get(5)
        )),
        new Meeting(3, "Luigi", DUMMY_ROOM.get(2), "16:00", Arrays.asList(
                DUMMY_USER.get(6),
                DUMMY_USER.get(2),
                DUMMY_USER.get(4)
        ))
