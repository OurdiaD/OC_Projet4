...
public abstract class ApiServiceGenerator {
    ...
    public static List<Meeting> DUMMY_MEETING = Arrays.asList(
        ...
        new Meeting(2, "Mario", DUMMY_ROOM.get(1), "23/07/2021"/*1626991200000L*/ ,"13:00", Arrays.asList(
                DUMMY_USER.get(3),
                DUMMY_USER.get(4),
                DUMMY_USER.get(5)
        )),
        new Meeting(3, "Luigi", DUMMY_ROOM.get(2),  "01/10/2021"/*1633039200000L*/,"16:00", Arrays.asList(
                DUMMY_USER.get(6),
                DUMMY_USER.get(2),
                DUMMY_USER.get(4)
        ))
